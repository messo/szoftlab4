...
Az áramkör objektum. Ez az objektum hozza létre és köti össze egymással az áramköri elemeket. Egy kiértékelési ciklusban minden komponenst kiértékel. A flip-flopokat utasítja arra, hogy mentsék el a jelenlegi kimenetüket belső állapotként és az órajel bemenetén lévő értéket az éldetektálás érdekében. Megmondja, hogy az áramköri elemek értékei megváltoztak-e. Ezen kívül lépteti a jelgenerátorokat.

\subsection{\bf Wire}
Vezeték, mely az áramköri komponensek ki és bemeneteit köti össze. Egy vezeték egy darab kimenet és egy darab bemenetet köt össze. A rajta lévő értéket le lehet tőle kérdezni, illetve be lehet azt állítani.
