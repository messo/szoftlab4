...
\usecase{Jelforrások módosítása}
{Az áramkör jelforrásainak módosítása}
{Felhasználó}
{A felhasználó az általa kiválasztott jelforrás értékét (kapcsoló) vagy értékeit (jelgenerátor) módosítja.}
