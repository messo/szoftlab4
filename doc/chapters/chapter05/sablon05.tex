...
\setlength{\itemsep}{0cm}%
\setlength{\parskip}{0cm}%
	\item toggle változásának vizsgálata (\textbf{megkérdezi a tesztelőt}, javasolt: 1)
...
\setlength{\itemsep}{0cm}%
\setlength{\parskip}{0cm}%
	\item toggle változásának vizsgálata (\textbf{megkérdezi a tesztelőt}, javasolt: 0)
