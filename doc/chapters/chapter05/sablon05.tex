...
\setlength{\itemindent}{-50pt}%
	...
	\setlength{\itemindent}{-60pt}%
		...
		\item inverter értékének kiadása a vezetékre (\textbf{megkérdezi a tesztelőt}, javasolt: 1)
	\end{itemize}
	...
	\setlength{\itemindent}{-60pt}%
		...
		\item node értékének kiadása a vezetékekre
	\end{itemize}
	\item led kiértékelése
	\begin{itemize}
	\setlength{\itemsep}{0cm}%
...
\setlength{\itemindent}{-50pt}%
	...
	\item led változásának vizsgálata (\textit{idáig nem kéne eljutni, ha fent jót válaszolt a tesztelő})
\end{itemize}
\item az áramkör ismét változott, nincs stacionárius állapota
\end{itemize}
\end{itemize}
\vspace{-15pt}}
